...
namespace vkPlayground {
	...
	{
		VKPG_CORE_WARN_TAG("Renderer", "Initializing Scene Renderer for scene: {0}", m_Scene->GetName());
	...
	{
		VKPG_VERIFY(!m_Active, "Not able to change scenes while active renderer");
		m_Scene = scene;
	}
