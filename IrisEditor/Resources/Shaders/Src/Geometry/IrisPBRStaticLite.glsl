...
void main()
{
	...
	// Write final color
	o_Color = vec4(iblContribution + (m_Params.Albedo * u_MaterialUniforms.Emission), 1.0f);

	// Shadow mask with respect to bright surfaces
	o_ViewNormalsLuminance.a = clamp(dot(o_Color.rgb, vec3(0.2125f, 0.7154f, 0.0721f)), 0.0f, 1.0f);
}