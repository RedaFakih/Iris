...
IncludeDir["msdfAtlasGen"]        = "%{wks.location}/Iris/dependencies/msdf-atlas-gen/msdf-atlas-gen"
IncludeDir["msdfGen"]             = "%{wks.location}/Iris/dependencies/msdf-atlas-gen/msdfgen"
