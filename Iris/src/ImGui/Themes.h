...
namespace Colors
{
	...
	namespace Theme {
		...
		constexpr auto BackgroundDarkBlend   = IM_COL32(26, 26, 26, 135);
		...
		constexpr auto ExceededDynamicLights = IM_COL32(255, 165, 0, 255);
		...
		constexpr auto MeshNotSet			 = IM_COL32(255, 165, 0, 255);
		...
		constexpr auto TextDisabledDark		 = IM_COL32(26, 26, 26, 165);
