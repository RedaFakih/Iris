...
namespace Iris {
	...
	public:
		...
		VkCommandBuffer GetCommandBuffer(uint32_t frameIndex) const { IR_ASSERT(frameIndex < m_CommandBuffers.size()); return m_CommandBuffers[frameIndex].CommandBuffer; }
