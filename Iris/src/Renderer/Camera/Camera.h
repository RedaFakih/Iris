...
namespace Iris {
	...
	public:
		...
		void SetOrthographicProjectionMatrix(const float width, const float height, const float nearP, const float farP);

		const glm::mat4& GetProjectionMatrix() const { return m_ProjectionMatrix; }
		const glm::mat4& GetUnReversedProjectionMatrix() const { return m_ProjectionUnReversedMatrix; }
	...
	private:
		...
		// For now only needed for shadow maps and ImGuizmo
		glm::mat4 m_ProjectionUnReversedMatrix = glm::mat4{ 1.0f };
